...
%                     Screen('DrawDots', woff1, [LocationListX(i,targetNum(i)) LocationListY(i,targetNum(i))], TargetSize, tempColor, [], 2);
                    targetShown(i) = 1;
                else
                    targetShown(i) = 0;
                end
            ...
            while i < size(targetFeedback,2)
                ...
                elseif ( getSecs-targetFeedback(3,i) <= FeedBackDuration & targetFeedback(3,i)~= 0 ) % show feedback
                    ...
                    screen('FillRect', woff1, targetFeedbackCols(targetFeedback(4,i),:,MoleTypeList(targetFeedback(6,i),targetFeedback(5,i))), targetArea(1,:));
                    screen('FillRect', woff1, targetFeedbackCols(mod(targetFeedback(4,i),2)+1,:,MoleTypeList(targetFeedback(6,i),targetFeedback(5,i))), targetArea(2,:));
                end
            end
