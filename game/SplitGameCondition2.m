...
for TrlNum = startTrialNum:endTrialNum
    ...
    woff1 = Screen('OpenOffScreenWindow',window,[0 0 0], [0 0 HalfScrRes]);   % Player 1's game
    woff2 = Screen('OpenOffScreenWindow',window,[0 0 0], [ScrRes(1)/2 0 ScrRes(1) ScrRes(2)]); % Player 2's game
    woff_fb1 = Screen('OpenOffScreenWindow',window,[0 0 0], [0 0 HalfScrRes]); % Player 1's feedback
    woff_fb2 = Screen('OpenOffScreenWindow',window,[0 0 0], [0 0 HalfScrRes]); % Player 2's feedback
...
%     disp(['Trial starts: ' num2str(TrlNum)]);
    ...
    while getSecs-tStart < TrialLength
        ...
        Screen('FillRect', woff2, [0 0 0 0]); % clear bg for pane 2
