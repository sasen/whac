...
tStart = reachInts(1,1); tEnd = reachInts(1,2);
...
% plot3(xyz(1,tOn:tEnd),xyz(2,tOn:tEnd),xyz(3,tOn:tEnd),'b.-')
% plot3(xyz(1,velIdx),xyz(2,velIdx),xyz(3,velIdx),'r.')
% plot3(xyz(1,tOn),xyz(2,tOn),xyz(3,tOn),'g*','MarkerSize',10)
% plot3(xyz(1,tEnd),xyz(2,tEnd),xyz(3,tEnd),'ko','MarkerSize',10)
